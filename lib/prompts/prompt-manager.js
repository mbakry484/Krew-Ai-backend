...
function analyzeContext(customerMessage, conversationHistory = [], metadata = null) {
  ...
  const productKeywords = ['what', 'show', 'available', 'have', 'stock', 'products', 'ايه', 'عندكو', 'متوفر', 'معاكم'];
...
function buildOptimizedPrompt({
  ...
  let prompt = coreIdentity.getPrompt(businessName);
  ...
  // Add product catalog if needed
  if (context.needsProductCatalog || context.isOrderIntent) {

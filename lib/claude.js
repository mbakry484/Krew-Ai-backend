 ...
 */
async function generateReply(customerMessage, knowledgeBaseRows, products, brandId, conversationHistory = []) {
  try {
...
STEP 2 — Collect order details (ask one or two at a time, don't overwhelm):
  - Full name
  - Phone number
  - Delivery address

STEP 3 — Show order summary and ask for confirmation:
  Once you have all details, present a clean summary like this:
...
STEP 4 — After confirmation:
  - Thank them warmly.
  - Let them know the team will follow up to arrange delivery.
  - Do NOT invent delivery times or promises not in the knowledge base.
